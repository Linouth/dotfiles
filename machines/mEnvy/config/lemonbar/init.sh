...
# Fonts
font1="Knack Nerd Font Mono:size=9"
# font2="-wuncon-siji-medium-r-normal--10-100-75-75-c-80-iso10646-1"

sh $HOME/.config/lemonbar/topbar.sh | lemonbar -f "$font1" -F $foreground -B $background -g "${width}x${height}+$xoff+$yoff" -o 1 -u 2 | while read action; do
    case "$action" in
